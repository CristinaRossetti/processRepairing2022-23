...
log = xes_importer.apply('C:/Users/crist/Desktop/FileBDA/testBank2000SCCUpdated/testBank2000SCCUpdatedCopia.xes') 
...
f = open(path + '/results_eval_multiple_testBank2000SSCUpdated.csv', 'a')
writer = csv.writer(f)
...
for a in alg: #seleziona l'algoritmo a nell'array alg per iterare sui diversi algoritmi
    ...
    for s in sub: #itera sul numero delle sub
        ...
        for r in rr: #itera sulle risorse di riparazione
            path = 'C:/Users/crist/Desktop/FileBDA/testBank2000SCCUpdated/' + str(a) +'/' + 'testlog_' + str(s) +'/' + 'r_' + str(r) +'/'
            os.chdir(path)
